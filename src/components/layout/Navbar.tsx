...
export const Navbar: React.FC<NavbarProps> = ({ onOpenCart }) => {
  ...
  return (
    <header className="w-full bg-white text-slate-900 border-b border-slate-200 sticky top-0 z-40">
      <div className="max-w-300 mx-auto px-4 py-3 flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
        {/* Brand Logo */}
        <Logo size="md" />

        {/* User Profile & Actions */}
        <div className="flex items-center gap-3 sm:gap-4">
          {/* Segmented Admin / Manager Role Toggle Component */}
          {session?.user && (
